...
class PlaceProvider extends ChangeNotifier {
  ...
  /// `true` when the initial search triggered by [PlacePicker.selectInitialPosition] is
  /// still pending (waiting for the first [PlacePicker.onCameraIdle] after map creation).
